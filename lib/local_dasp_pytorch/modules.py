...
class ParametricEQ(Processor):
    def __init__(
        ...
        self.param_ranges = {
            ...
            "band4_gain_db": (min_gain_db, 0),
            "band4_cutoff_freq": (80, 2000),
