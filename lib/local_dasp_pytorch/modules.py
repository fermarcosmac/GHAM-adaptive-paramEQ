...
class ParametricEQ(Processor):
    def __init__(
        ...
        self.param_ranges = {
            ...
            #"low_shelf_cutoff_freq": (20, (sample_rate // 2) - 1000),
            "low_shelf_q_factor": (min_q_factor, max_q_factor),
            "band0_gain_db": (min_gain_db, 10),
             "band0_cutoff_freq": (80, 2000),
            #"band0_cutoff_freq": (20, (sample_rate // 2) - 1000),
            "band0_q_factor": (min_q_factor, max_q_factor),
            "band1_gain_db": (min_gain_db, 10),
            "band1_cutoff_freq": (2000, 8000),
            #"band1_cutoff_freq": (20, (sample_rate // 2) - 1000),
            "band1_q_factor": (min_q_factor, max_q_factor),
            "band2_gain_db": (min_gain_db, 10),
            "band2_cutoff_freq": (8000, 12000),
            #"band2_cutoff_freq": (20, (sample_rate // 2) - 1000),
            "band2_q_factor": (min_q_factor, max_q_factor),
            "band3_gain_db": (min_gain_db, 10),
            "band3_cutoff_freq": (12000, (sample_rate // 2) - 1000),
            #"band3_cutoff_freq": (20, (sample_rate // 2) - 1000),
            "band3_q_factor": (min_q_factor, max_q_factor),
            "band4_gain_db": (min_gain_db, 10),
            "band4_cutoff_freq": (80, 500),
            ...
            #"high_shelf_cutoff_freq": (20, (sample_rate // 2) - 1000),
